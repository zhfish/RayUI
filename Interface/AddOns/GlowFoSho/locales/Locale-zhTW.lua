...
L["Show Glowless Enchants"] = "顯示附魔效果"
L["Allows you to preview enchants which do not add glow to a weapon."] = "允許您預覽未附魔武器的附魔效果。"
...
L["Show DK Runes"] = "死亡騎士符文"
L["Allows you to preview Runes which are created by DKs."] = "可以預覽死亡騎士制造的符文效果。"
