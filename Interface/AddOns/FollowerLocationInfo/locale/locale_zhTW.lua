...
L["Quest giver"] = "任務給予者";
L["Vendor for "] = "商店在";
L["Unable to load correct faction followers... (Blizzard Bug)"] = "無法載入正確聲望的追隨者...(暴雪的Bug)";
L["Follower listing disabled because a blizzard bug prevents loading the correct faction followers."] = "追隨者清單已禁用因為暴雪的Bug會導致載入錯誤聲望的追隨者。";
L["|cffffaa00Follower listing disabled. You must be level 90 or higher. The follower list will be automaticly enabled on level 90.|r"] = "|cffffaa00追隨者清單已禁用。您必須高於90等。追隨者列表將在90等後自動啟用。";
L["Show/Hide follower list"] = "顯示/隱藏 追隨者清單";
L["Show/Hide minimap button"] = "顯示/隱藏 小地圖按鈕";
L["Usage"] = "使用方法";
L["Select a follower to see the description..."] = "點選一個追隨者以查看說明...";
L["Filter %d/%d"] = "過濾 %d/%d";
L["Followers"] = "追隨者";
L["Basic abilities"] = "基礎技能";
L["Click to expand/collapse"] = "點擊來展開/收起";
L["This follower is member of a collect group and is no longer collectable."] = "此追隨者是拾荒組的成員之一，但不再具有收藏價值。";
L["This follower is member of a collect group and is collectable."] = "此追隨者是拾荒組的成員之一，具有收藏價值。";
L["In group with:"] = "在何群組：";
L["Appears on your position"] = "出現在您的位置";
L["Cave on image 1"] = "從圖片1洞穴旁邊上去";
L["Hidden cave"] = "隱密的山洞";
...
L["Fishing Shack 3"] = "釣屋 3";
L["Fishing skill 700"] = "釣魚等級700";
L["Lunarfall Inn"] = "落月旅店";
L["Brawler's Guild Rank 5"] = "鬥陣俱樂部等級5";
L["Counters"] = "反制";
