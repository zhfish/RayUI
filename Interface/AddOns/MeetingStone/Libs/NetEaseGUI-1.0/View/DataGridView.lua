...
function DataGridView:AddHeader(key, text, width, alignOrClass, showHandler, sortHandler, formatHandler, textHandler, iconHandler, atlasHandler)
    ...
    Button.textHandler = textHandler
    Button.iconHandler = iconHandler
    Button.atlasHandler = atlasHandler
