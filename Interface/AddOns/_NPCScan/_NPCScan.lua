...
function private.GenerateTargetMacro(instanceid)
	...
	-- for npc_id, npc_name in pairs(_G._NPCScanOptions.NPCs) do
		-- if not _G._NPCScanOptions.IgnoreList.NPCs[npc_id] and _G._NPCScanOptions.NPCWorldIDs[npc_id] and _G._NPCScanOptions.NPCWorldIDs[npc_id] == private.LOCALIZED_CONTINENT_NAMES[continent_id] then
